 ...
 * 
 * public class AppUserDTO implements UserDetails { private static final long
 * serialVersionUID = 1L; private String username; private String password;
 * 
 * public AppUserDTO(String username, String password) { this.password =
